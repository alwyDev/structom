                ...
                <div class="container-fluid">
                    ...
                    <div class="card mb-3">
                        <div class="card-header">
                            <a href="<?php echo site_url('admin/exercise/') ?>"><i class="fas fa-arrow-left"></i> Back</a>
                        </div>
                        <div class="card-body">

                            <form action="<?php echo site_url('admin/exercise/add') ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control <?php echo form_error('analisa') ? 'is-invalid' : '' ?>" type="text" name="analisa" min="0" placeholder="Analisa" />
                                    <div class="invalid-feedback">
